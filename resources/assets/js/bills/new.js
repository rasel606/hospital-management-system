    ...
    if (index - 1 == 0) {
        $("#billTbl tbody").append(
            "<tr>" +
                ...
                '<input class="form-control itemName" required name="item_name[]" type="text" placeholder="'+Lang.get('js.item_name') +'"></td>' +
                '<td class="table__qty"><input class="form-control qty quantity" required name="qty[]" type="text" placeholder="'+Lang.get('js.qty')+'"></td>' +
                '<td><input class="form-control price-input price" required name="price[]" type="text" placeholder="'+ Lang.get('js.price') +'"></td>' +
