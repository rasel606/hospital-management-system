                    ...
                    <div class="card-body  border-top p-9">
                        <div class="row mb-7">
                            <div class="col-lg-4 d-flex flex-column">
                                <label class="fw-bold text-muted py-3">{{ __('messages.bed_status.patient_name')  }}</label>
                                <span class="fw-bolder fs-6 text-gray-800">{{$pathologyTest->patient->patientUser->full_name ?? __('messages.common.n/a')}}</span>
                            </div>
                            <div class="col-lg-4 d-flex flex-column">
