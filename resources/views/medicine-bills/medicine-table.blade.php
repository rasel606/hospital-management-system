                ...
                <table class="table table-striped" id="prescriptionMedicalTbl">
                    ...
                    <tbody class="medicine-bill-container">
                        @if (isset($medicineBill))
                            @foreach ($medicineBill->saleMedicine as $key => $saleMedicine)
                                ...
                                {{ Form::number('lot_no[]', null, ['class' => 'form-control', 'id' => 'lot_no1','required','placeholder'=>'Lot no.']) }}
                                    ...
                                    <td>
                                        {{ Form::text('sale_price[]', number_format($saleMedicine->sale_price, 2, '.', ''), ['placeholder' => __('messages.medicine_bills.sale_price'),'class' => 'form-control medicineBill-sale-price price-format ', 'id' => 'medicine_sale_price' . $key + 1, 'required']) }}
                                    </td>
                                    {{--  <td>
                                {{ Form::number('purchase_price[]', '0.00', ['class' => 'form-control purchase-price', 'readonly', 'rows'=>1, 'id' => 'purchase_price1','required' ]) }}
                                    ...
                                    <td>
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-text ms-0 available_qty" id="availableQtyId1">{{$saleMedicine->medicine->available_quantity}}</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="input-group">
                        ...
                        {{ Form::number('lot_no[]', null, ['class' => 'form-control', 'id' => 'lot_no1','required','placeholder'=>'Lot no.']) }}
                                ...
                                <td>
                                    {{ Form::text('sale_price[]', '0.00', ['placeholder' => __('messages.medicine_bills.sale_price'),'class' => 'form-control medicineBill-sale-price price-format', 'required', 'id' => 'medicine_sale_price1']) }}
                                </td>
                                {{--  <td>
                        {{ Form::number('purchase_price[]', '0.00', ['class' => 'form-control purchase-price', 'readonly', 'rows'=>1, 'id' => 'purchase_price1','required' ]) }}
                    </td>  --}}
            ...
            <div class="row mt-5 justify-content-between">
                ...
                <div class="col-xl-4 col-md-5">
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <div>
                            {{ Form::select('payment_type', App\Models\PurchaseMedicine::PAYMENT_METHOD, null, ['placeholder' => __('messages.purchase_medicine.payment_mode'),'class' => 'form-select medicine-payment-mode', 'placeholder' => __('messages.purchase_medicine.payment_mode'), 'id' => 'paymentMode', 'required']) }}
                        </div>
                    </div>
                    <div>
                        <label
