        ...
        <table class="table table-striped" id="billTbl">
            ...
            @if(isset($bill))
                @foreach($bill->billItems as $billItem)
                    <tr>
                        ...
                        <td>
                            {{ Form::text('price[]', number_format($billItem->price), ['class' => 'form-control price-input price','required', 'placeholder' => __('messages.bill.price')]) }}
                        </td>
            ...
            @else
                <tr>
                    ...
                    <td>
                        {{ Form::text('price[]', null, ['class' => 'form-control price-input price','required','placeholder' => __('messages.bill.price')]) }}
                    </td>
